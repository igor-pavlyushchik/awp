...
public class ImageProcessHandler implements RequestHandler<Map<String, Object>, APIGatewayProxyResponseEvent> {
  ...
  private static final String SQS_QUEUE_NAME = "task8-uploads-notification-queue";
  private static final String TOPIC_ARN = "arn:aws:sns:eu-north-1:868790782174:task8-uploads-notification-topic";
